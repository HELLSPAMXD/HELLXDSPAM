...
API_ID = 19071785
API_HASH = "7a4cb2c9b45ce0602ef24c24555dc2bf"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5883918742").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5883918742"))
